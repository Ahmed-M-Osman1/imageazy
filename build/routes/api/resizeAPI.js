...
resizeAPI.get('/', function (req, res) {
    ...
    fs_1.default.readdir(ImagePath, function (err, files) {
        ...
        files.forEach(function (file) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fileName = path_1.default.parse(file);
                        return [4 /*yield*/, filesOnInputFolder.push(fileName.name)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    if (function (isFileExist) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
